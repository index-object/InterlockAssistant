...
a = Analysis(
    ...
    excludes=[
        ...
        'PySide6.QtMultimedia', 'PySide6.QtNetworkAuth', 'PySide6.QtNfc',
        'PySide6.QtPdf', 'PySide6.QtPositioning', 'PySide6.QtQuick',
        'PySide6.QtRemoteObjects', 'PySide6.QtScxml', 'PySide6.QtSensors',
        'PySide6.QtSerialBus', 'PySide6.QtSerialPort', 'PySide6.QtSpatialAudio',
        'PySide6.QtSql', 'PySide6.QtStateMachine', 'PySide6.QtWebChannel',
        'PySide6.QtWebEngine', 'PySide6.QtWebSockets', 'PySide6.QtWebView',
        'PySide6.QtHelp', 'PySide6.QtAxContainer',
    ],
    noarchive=False,
    optimize=0,
)
